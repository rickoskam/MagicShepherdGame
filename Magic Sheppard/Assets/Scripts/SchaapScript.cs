    ...
    void Update()
    {
        ...
        for (int j = 0; j<lengte; j++)
        {
            ...
            if (herdernietdichtbij == true)
            {
                ...
                schaapje.transform.Translate(new Vector3(randx*speed*Time.deltaTime*0.01f, 0.0f, randz*speed*Time.deltaTime*0.01f));
                ...
                schaapje.transform.rotation = Quaternion.Slerp(transform.rotation, lookrotation, 0.01f);
            }
            ...
            if (afstandhond <=5)
            {
				...
				Vector3 direction1 = new Vector3(xverschil * speed * Time.deltaTime * 0.1f, 0.0f, zverschil * speed * Time.deltaTime * 0.1f);
				Quaternion lookrotation = Quaternion.LookRotation(direction1);
				schaapje.transform.rotation = Quaternion.Slerp(transform.rotation, lookrotation, Time.deltaTime);
            }
            else
            {
            ...
            if (euclid <= 20)
            {
				...
				Quaternion lookrotation = Quaternion.LookRotation(direction1.normalized);
				schaapje.transform.rotation = lookrotation; //Quaternion.Slerp(transform.rotation, lookrotation, 0.01f);
            }
            else
            {
                herdernietdichtbij = true;
		...
		GameObject Schuur = GameObject.FindGameObjectWithTag("Schuur");

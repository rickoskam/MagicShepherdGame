...
public class LandschapScript : MonoBehaviour {
	...
	void generateTerrain(){
		...
		// voorwerpen spawnen
		GameObject ijsje = Resources.Load ("IceCream") as GameObject;
		GameObject wafel = Resources.Load ("Waffle") as GameObject;
		GameObject donut = Resources.Load ("Donuts") as GameObject;
